...
public class SalleServiceTest {
    ...
    public void setUp() {
        ...
        salle = new Salle();
        salle.setCode("A200"); // Exemple de code pour la salle
    ...
    public void testCreate() {
        assertNotNull("Les salles doivent etre crees avec un ID", salle.getId());
    }
    ...
    public void testUpdate() {
        salle.setCode("B206"); // Modifiez le code pour tester la mise à jour
        ...
        assertEquals("Updated salle code should match", "B206", updatedSalle.getCode());
    }
