...
public class MachineServiceTest {
    ...
    public void setUp() {
        ...
        salle = new Salle("A200"); // Exemple de salle

        // Persister la salle avant d'utiliser
        salleService.create(salle);

        machine = new Machine();
        machine.setRef("MACH-009");
    ...
    public void testCreate() {
        assertNotNull("les machines doivent etre crees avec un ID", machine.getId());
    }
    ...
    public void testUpdate() {
        machine.setRef("MACH-006"); // Modifiez la référence pour tester la mise à jour
