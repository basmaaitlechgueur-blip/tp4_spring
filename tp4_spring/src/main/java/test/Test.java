...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Salle salle1 = new Salle("A15");
        Salle salle2 = new Salle("B12");
        salleService.create(salle1);
        salleService.create(salle2);

        // Création et insertion de machines
        Machine machine1 = new Machine("M122", new Date(), salleService.findById(1));
        Machine machine2 = new Machine("M144", new Date(), salleService.findById(2));
        ...
        Date d1 = new Date(110, 0, 3); // 1er janvier 2010
        Date d2 = new Date(); // Date actuelle
        System.out.println(" les Machines achetées entre " + d1 + " et " + d2 + ":");
